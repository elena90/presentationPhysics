...
$(window).on('ChangeSlide', function (evt, number) {
    ...
    var $innerContainer = $currentSlide.find('.js-example21');

    if($innerContainer.length) {
        startExample21();
        
    } else {
        $.Window.trigger('stopExample21');
    }
});


function startExample21() {
    var $obj = $('.ball21');
    var $floor = $('.floor41');
    ...
    $.Window.on('stopExample21', function () {
        stopAnimate();
    });
