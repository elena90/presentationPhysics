...
$(window).on('ChangeSlide', function (evt, number) {
    ...
    var $innerContainer = $currentSlide.find('.js-example22');

    if($innerContainer.length) {
        startExample22();
        
    } else {
        $.Window.trigger('stopExample22');
    }
});


function startExample22() {
    var $obj = $('.ball22');
    var $floor = $('.floor42');
    ...
    $.Window.on('stopExample22', function () {
        stopAnimate();
    });
    ...
    function init() {
        ...
        obj.pos = new Vector(150, 50);
        obj.changeStyles();
        obj.velo = new Vector(10, 10)

        // Рисуем пол
        var b1 = new Vector(100, 300);
        var b2 = new Vector(800, 500);
